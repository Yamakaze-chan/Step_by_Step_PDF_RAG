...
def initialize_llmchain(
    ...
    llm = GPT4All(
        model=llm_model, #I'm not sure does gPT4All can get from HuggingFace or not so in case it throw an Error, please download model from path and change code of this line
        n_threads = 8
    )
